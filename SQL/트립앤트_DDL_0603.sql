...
CREATE TABLE "MEMBER" (
	...
	"MEM_PASSWORD"	VARCHAR2(100)		NULL,
...
COMMENT ON COLUMN "MEMBER"."MEM_ROLE" IS '회원 권한 등급 [휴면회원(ROLE_SLEEP), 일반회원(ROLE_MEM), 폰트 적용 회원(ROLE_VIP), 관리자(ROLE_ADMIN), 소유자(ROLE_OWNER)]';
...
COMMENT ON COLUMN "PLACE_MOVE_TIME"."AREACODE" IS '장소 코드';
