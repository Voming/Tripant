...
COMMENT ON COLUMN "MEMBER"."MEM_ROLE" IS '회원 권한 등급 [일반회원(MEM), 관리자(ADMIN), 소유자(OWNER)]';
...
CREATE TABLE "PLACE" (
	...
	"CONTENTTYPEID"	VARCHAR2(10)		NULL,
	...
	"MAPX"	VARCHAR2(50)		NULL,
	"MAPY"	VARCHAR2(50)		NULL,
	...
	"GETTIME"	DATE	DEFAULT SYSDATE	NULL
);
...
COMMENT ON COLUMN "PLACE"."CONTENTTYPEID" IS '관광타입';
