...
COMMENT ON COLUMN "MEMBER"."MEM_FONT_EXP" IS '글꼴 만료 일자';
...
COMMENT ON COLUMN "QUIT_MEMBER"."MEM_EMAIL" IS '회원 이메일';
...
CREATE TABLE "BUY" (
	...
	"BUY_PAYMENT_ID"	VARCHAR2(100)		NOT NULL,
...
COMMENT ON COLUMN "BUY"."BUY_PAYMENT_ID" IS '주문번호';
