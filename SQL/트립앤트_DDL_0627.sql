...
CREATE TABLE "DIARY_SAVE" (
	"DIARY_ID"	NUMBER		NOT NULL,
	"DIARY_MEM_EMAIL"	VARCHAR2(100)		NOT NULL,
	"DLARY_IMAGE"	CLOB		NULL,
	"DLARY_PREVIEW"	VARCHAR2(1500)		NULL
);
...
COMMENT ON COLUMN "DIARY_SAVE"."DLARY_IMAGE" IS '파일 서버 이미지 UPL 가져오기';

COMMENT ON COLUMN "DIARY_SAVE"."DLARY_PREVIEW" IS '글 text 500자 정도 꺼내기';

CREATE TABLE "PLAN_EDIT" (
	"EDIT_PLAN_ID"	NUMBER		NOT NULL,
	"EDIT_SPOT_ID"	NUMBER		NOT NULL,
	"EDIT_STAY_TIME"	VARCHAR2(50)		NOT NULL,
	"EDIT_SPOT_ORDER"	NUMBER		NULL,
	"EDIT_SCHEDULE_START"	VARCHAR2(20)		NOT NULL,
	"EDIT_SCHEDULE_END"	VARCHAR2(20)		NOT NULL,
	"EDIT_LAT"	VARCHAR2(50)		NOT NULL,
	"EDIT_LNG"	VARCHAR2(50)		NOT NULL,
	"EDIT_MEMO"	(VARCHAR2(3000)		NOT NULL,
	"EDIT_TITLE"	VARCHAR2(500)		NOT NULL
);

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_PLAN_ID" IS '일정ID';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_SPOT_ID" IS '장소ID';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_STAY_TIME" IS '머무는시간';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_SPOT_ORDER" IS '방문순서';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_SCHEDULE_START" IS '여행 시작시간';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_SCHEDULE_END" IS '여행종료시간';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_LAT" IS '위도mapy';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_LNG" IS '경도mapx';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_MEMO" IS 'memo';

COMMENT ON COLUMN "PLAN_EDIT"."EDIT_TITLE" IS '장소명';
...
ALTER TABLE "PLAN_SPOT" ADD CONSTRAINT "FK_PLAN_SCHEDULE_TO_PLAN_SPOT_2" FOREIGN KEY (
	"SPOT_PLAN_ID"
)
REFERENCES "PLAN_SCHEDULE" (
	"SCHEDULE_PLAN_ID"
...
ALTER TABLE "PLAN_SPOT" ADD CONSTRAINT "FK_PLACE_TO_PLAN_SPOT_2" FOREIGN KEY (
	"SPOT_CONTENTID"
)
REFERENCES "PLACE" (
	"CONTENTID"
...
ALTER TABLE "PLAN_STAY" ADD CONSTRAINT "FK_PLAN_SCHEDULE_TO_PLAN_STAY_2" FOREIGN KEY (
	"STAY_PLAN_ID"
)
REFERENCES "PLAN_SCHEDULE" (
	"SCHEDULE_PLAN_ID"
...
ALTER TABLE "PLAN_STAY" ADD CONSTRAINT "FK_PLACE_TO_PLAN_STAY_2" FOREIGN KEY (
	"STAY_TYPE"
)
REFERENCES "PLACE" (
	"TYPE"
...
ALTER TABLE "PLACE_MOVE_TIME" ADD CONSTRAINT "FK_PLACE_TO_PLACE_MOVE_TIME_3" FOREIGN KEY (
	"TYPE_END"
)
REFERENCES "PLACE" (
	"TYPE"
...
ALTER TABLE "PLACE_MOVE_TIME" ADD CONSTRAINT "FK_PLACE_TO_PLACE_MOVE_TIME_4" FOREIGN KEY (
	"CONTENTID_END"
)
REFERENCES "PLACE" (
	"CONTENTID"
...
ALTER TABLE "DIARY_SAVE" ADD CONSTRAINT "FK_DIARY_TO_DIARY_SAVE_2" FOREIGN KEY (
	"DIARY_MEM_EMAIL"
)
REFERENCES "DIARY" (
	"DIARY_MEM_EMAIL"
