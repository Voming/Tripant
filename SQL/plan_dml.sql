...
insert INTO plan_schedule VALUES ( (select plan_start_day from plan where plan_id=1), 1, TO_DATE('2024-05-30 10:00:00','YYYY-MM-DD HH24:MI:SS') ,  TO_DATE('2024-05-30 22:00:00','YYYY-MM-DD HH24:MI:SS') );
insert INTO plan_schedule VALUES ( (select plan_start_day from plan where plan_id=1)+1, 1, TO_DATE('2024-05-30 10:00:00','YYYY-MM-DD HH24:MI:SS') ,  TO_DATE('2024-05-30 22:00:00','YYYY-MM-DD HH24:MI:SS') );
insert INTO plan_schedule VALUES ( (select plan_start_day from plan where plan_id=1)+2, 1, TO_DATE('2024-05-30 10:00:00','YYYY-MM-DD HH24:MI:SS') ,  TO_DATE('2024-05-30 22:00:00','YYYY-MM-DD HH24:MI:SS') );
