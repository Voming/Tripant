		...
		CKEDITOR.ClassicEditor.create(document.getElementById(editorId), {
			...
			fontFamily: {
				options: [
					'default',
					//유료 폰트들
					'Ownglyph_meetme-Rg','Ownglyph_Dailyokja-Rg','InkLipquid','InkLipquid','DungGeunMo','KOTRAHOPE',
					'KyoboHand','SDSamliphopangche_Outline',
					//---
			...
			//--------이미지 업로드
			ckfinder : { 
			 	uploadUrl: contextPath + 'post/cloudinary?'+ header+"="+token
			},
